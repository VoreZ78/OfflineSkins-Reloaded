...
public class SkinUtils {
    ...
    private static final Function<GameProfile, PlayerSkinType> MODEL = profile -> PlayerSkinType.byModelMetadata(FabricOfflineSkinsReloaded.getSkinType(profile, null));
